...
argument-hint: load|start|review|test|explain|complete|delete
---
...
| `test`     | Check for testable logic for serveractions and utilities     |
| `explain`  | Document what changed and why                                |
| `complete` | Commit, push                                                 |
| `delete`   | Checkout to the develop, pull develop, delete previus branch |
